...
public class GuiFiveChess extends JFrame implements MouseListener, Runnable {
	...
	public void mousePressed(MouseEvent e) {
		...
		if (e.getX() >= 400 && e.getX() <= 470 && e.getY() >= 320
				&& e.getY() <= 350) {
			JOptionPane.showMessageDialog(this, "本游戏由XXXX制作!");
		}
		// 点击 退出 按钮
	...
	public static void main(String[] args) {
		GuiFiveChess ff = new GuiFiveChess();
	}
}
