...
public class GoGame {
	 ...
	 *            棋盘类
	 */
	public GoGame(Chessboard chessboard) {
	...
	public void start() throws Exception {
		...
		while ((inputStr = br.readLine()) != null) {
			...
			// 把对应的数组元素赋为"●"
			String chessman = Black.getBlack().getChessMan();
			...
			if (isWon(posX, posY, chessman)) {
				...
				chessman = White.getWhite().getChessMan();
	...
	public boolean isReplay(String chessman) throws Exception {
		chessboard.printBoard();
		String message = chessman.equals(Black.getBlack().getChessMan()) ? "恭喜您，您赢了，"
				: "很遗憾，您输了，";
	...
	public static void main(String[] args) throws Exception {
		...
		GoGame gb = new GoGame(new Chessboard());
		gb.start();
	}
}
